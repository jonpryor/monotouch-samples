...
namespace MonoCatalog {
	...
	public class AlertsViewDemo
	{
		UIView view;

		public AlertsViewDemo (UIView view)
		{
			this.view = view;
		}
		...
		public UITableViewDataSource CreateDataSource ()
		{
			return new DataSource ();
		}

		public UITableViewDelegate CreateDelegate ()
		{
			return new TableDelegate (this);
		}
		...
		public class TableDelegate : UITableViewDelegate {
			...
			public TableDelegate (AlertsViewDemo avc)
			{
				this.avc = avc;
			}
