...
namespace MonoCatalog.iPad {
	...
	public partial class DetailViewController {
		...
		private MonoTouch.UIKit.UIView __mt_content;
		...
		[MonoTouch.Foundation.Connect("content")]
		private MonoTouch.UIKit.UIView content {
			get {
				this.__mt_content = ((MonoTouch.UIKit.UIView)(this.GetNativeField("content")));
				return this.__mt_content;
			}
			set {
				this.__mt_content = value;
				this.SetNativeField("content", value);
			}
		}
